...
CREATE TABLE `select_master` (
  ...
  `selectkey` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `select_master` VALUES (1,'coursename','coursename'),(2,'language','language'),(3,'technology','technology'),(4,'tech_level','tech_level');
