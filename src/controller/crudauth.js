...
// app.post('/detailform', async (req, res) => {
  ...
  //    var sql1 = `SELECT * FROM educationdetails where employeeid=${e_id}`;
...
//   app.get('/detailform/:id', async (req, res) => {
      ...
      // console.log(result5);
      // console.log(result6);
      res.render("updateform",{result,result1,result2,result3,result4,result5})
      };
