...
// app.post('/detailajax', async (req, res) => {
...
//       console.log(err);
//     else{
//         console.log("hello world heeerere")
//         res.render('detailajax', {result });
//     }
//    })
           //res.render('list');
...
// app.get('/detailajax/:id', async (req, res) => {
    ...
    // app.post('/detailajax/:id/update', async (req, res) => {
